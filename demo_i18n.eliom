...
let%shared page () =
  (* Syntax [%i18n key] or [%i18n Module.key] inserts
     ...
     assets/maxi_passat_Demo_i18n.tsv
    ...
    ; p
        [%i18n
          Demo.internationalization_2
            ~f1:[code [txt "assets/maxi_passat_i18n.tsv"]]
            ~f2:[code [txt "maxi_passat_i18n.eliom"]]]
    ; p [txt [%i18n Demo.S.internationalization_3]]
    ; p
        [%i18n
          Demo.internationalization_4
            ~f:[code [txt "assets/maxi_passat_Demo_i18n.tsv"]]
...
let%shared () =
  Maxi_passat_base.App.register ~service:Demo_services.demo_i18n
    ( Maxi_passat_page.Opt.connected_page @@ fun myid_o () () ->
      let%lwt p = page () in
      Maxi_passat_container.page ~a:[a_class ["os-page-demo-i18n"]] myid_o p )
