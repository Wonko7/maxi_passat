  ...
  Lwt.return
    ...
    ; p
        [%i18n
          Demo.tips4
            ~set_page:
              [a ~service:Maxi_passat_services.settings_service [%i18n Demo.tips5] ()]]
    ]
...
let%shared () =
  Maxi_passat_base.App.register ~service:Demo_services.demo_tips
    ( Maxi_passat_page.Opt.connected_page @@ fun myid_o () () ->
      let%lwt p = page () in
      Maxi_passat_container.page ~a:[a_class ["os-page-demo-tips"]] myid_o p )
