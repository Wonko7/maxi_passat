...
let%shared () =
  Maxi_passat_base.App.register ~service:Demo_services.demo_pagetransition
...
let%shared () =
  ...
  in
  Maxi_passat_base.App.register ~service:Demo_services.detail_page
    (Maxi_passat_page.Opt.connected_page detail_page_handler)
