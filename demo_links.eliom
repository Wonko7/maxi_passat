...
let%shared page () =
  Lwt.return
    ...
    ; p
        [%i18n
          Demo.services_1
            ~f1:[code [txt "maxi_passat_services.eliom"]]
            ~f2:[code [txt "maxi_passat_handlers.eliom"]]
            ~f3:[code [txt "maxi_passat.eliom"]]]
...
let%shared () =
  Maxi_passat_base.App.register ~service:Demo_services.demo_links
    ( Maxi_passat_page.Opt.connected_page @@ fun myid_o () () ->
      let%lwt p = page () in
      Maxi_passat_container.page ~a:[a_class ["os-page-demo-links"]] myid_o p )
